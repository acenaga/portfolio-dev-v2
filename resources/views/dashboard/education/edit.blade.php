        ...
        <div class="col-12 col-md-6 col-lg-4">
            <form action="{{ route('education.update', $education) }}" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control" id="degree-obtain"
                        placeholder="Informatic TSU" maxlength="40" value="{{ old('title', $education->title) }}">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="institute_name" class="form-control" id="institute-name"
                        placeholder="Davinci School" value="{{ old('institute_name', $education->institute_name) }}">
                </div>
                <div class="mb-3">
                    <label for="description-degree" class="form-label">Degree Description</label>
                    <textarea class="form-control" name="description" id="description-degree" rows="3">{{ old('description', $education->description) }}</textarea>
                </div>
                <div class="mb-3">
                    ...
                    <input type="url" name="url" class="form-control" id="institute-url"
                        ...
                        value="{{ old('url', $education->url) }}">
                </div>
                <div class="mb-3">
                    <label for="start-date" class="form-label">Start Date</label>
                    <input name="start_date" class="form-control" list="start-year" id="start-date"
                        placeholder="Type to search year..." value="{{ old('start_date', $education->start_date) }}">
                ...
                <div class="mb-3">
                    ...
                    <input name="end_date" class="form-control" list="end-year" id="end-date"
                        placeholder="Type to search year..." value="{{ old('end_date', $education->end_date) }}">
