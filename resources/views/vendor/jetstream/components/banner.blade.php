...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}" :class="{ 'bg-indigo': style == 'success', 'bg-danger': style == 'danger' }"
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="flex-shrink-0">
                <button type="button" class="btn btn-link d-flex p-2 rounded-md" aria-label="Dismiss"
                    ...
                    <svg class="text-white h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none"
